<?php
        ...
        if($cmd == "Add")
        {
            ...
            else
            {
                ...
                if($addDetailsRstArray)
                {
                    ...
                    $_SESSION[$module_name]["notificationMsg"] = "The Debate   has been successfully saved.";
        ...
        else if($cmd == "Edit")
        {
            ...
            else
            {
                ...
                if($setDetailsRstArray)
                {
                    ...
                    $notificationMsg = "The Debate   has been successfully updated.";
                }   
            }
    ...
    else
    {
        ...
        $displayData = $admin_reply->DisplayAllDetails($pageNo,$GLOBAL_ITEM_PERPAGE,"debate",$filter);
    }
...
<div id="container">      
    ...
    ?>
        <div id="secondary">
            <ul>
                <li <?=($action == "")? "class='current'":""?>><a href="<?=$GLOBAL_ADMIN_SITE_URL.$module_name?>">View Debate </a></li>
                
                <?=($action == "Edit")? "<li class='current'><a href='".$GLOBAL_ADMIN_SITE_URL.$module_name."&action=View&replyID=".$replyID."'>View Specific Debate </a></li>": "";?>
            </ul>
            <div class="clr"></div>
        </div>
        <div id="content">
            ...
            ?>
                <h2><?=($action == "Add")? "Add A New": "View"?> Debate </h2>
                <?
            ...
            ?>
                    ...
                    <table>
                        ...
                        ?>
                                    <tr>
                                        ...
                                        <td><?php
        	                                ...
        	                                else if ($value["fullname"] != "" && $value["fullname"] != "undefined")
            	                            	echo $value["fullname"];
                	                        else if ($value["fbName"] != "" && $value["fbName"] != "undefined")
                    	                    	echo $value["fbName"];
                                        ?></td>
                                        <td>
                        ...
                        ?>
                                <tr>
                                    <td colspan="4">There is no debate yet.</td>
                                </tr>
                        <?
                            }
                        ?>
