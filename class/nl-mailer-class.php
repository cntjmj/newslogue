...
class Mailer {
	...
	public function sendVerification($emailaddress, $displayName, $uniqCode) {
		if ($emailaddress == "" || $displayName == "" || $uniqCode == "")
			return false;

		$html = sprintf(Mailer::ACCOUNT_VERIFICATION, $displayName, CONFIG_PATH::GLOBAL_API_BASE, $uniqCode, $emailaddress);

		$this->phpmailer->AddAddress($emailaddress);
		$this->phpmailer->SetFrom("verify@newslogue.com", "Newslogue");
		$this->phpmailer->Subject = "Newslogue Account Verification";
